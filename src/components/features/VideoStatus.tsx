      ...
      <div className="space-y-6">
        ...
        >
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center shadow-md">
        ...
        <div
          ...
          aria-atomic="true"
        >
          <p className="text-neutral-600 font-medium text-sm">{STATUS_MESSAGES[status]}</p>
